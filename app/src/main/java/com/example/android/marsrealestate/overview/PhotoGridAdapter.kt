...
class PhotoGridAdapter : ListAdapter<MarsProperty, PhotoGridAdapter.MarsPropertyViewHolder>(DiffCallback) {
    ...
    // TODO (07) Add unimplemented members for PhotoGridAdapter, create and implement
    //  DiffCallback companion class
    ...
    override fun onCreateViewHolder(parent: ViewGroup,
                                    viewType: Int): PhotoGridAdapter.MarsPropertyViewHolder {
